...
class viewModel {//decla la clase viewModel que contiene las funciones para manejar las vistas
    protected static function get_view($view){//define una funcion estatica protegida llamada get_view que recibe un nombre de vista
        $white_list = ["login", "home", "new-product", "products", "edit-product", "users","category", "new-user", "edit-user", "new-category","edit-category", "new-provider", "provider", "edit-provider", "new-client", "clients", "edit-client","products"];//lista blanca de vistas permitidas
